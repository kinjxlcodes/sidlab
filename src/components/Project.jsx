    ...
    return (
      <div id="projects">
        <div className="border-b border-neutral-100 pb-4">
          ...
          <div className="w-full lg:w-auto mt-12 flex justify-around space-x-4">
            <a href="https://aiwisepartners.com/" target="_blank" rel="noopener noreferrer" className="relative group w-1/3">
              <img className="h-auto w-full shadow-lg dark:shadow-black/30 transition-transform duration-500 group-hover:scale-110 group-hover:blur-sm rounded-lg" src="src/assets/projects/project1.png" alt="AIwise Partners"/>
            ...
            <a href="https://www.awarewilderness.com/" target="_blank" rel="noopener noreferrer" className="relative group w-1/3">
              <img className="h-auto w-full shadow-lg dark:shadow-black/30 transition-transform duration-500 group-hover:scale-110 group-hover:blur-sm rounded-lg" src="src/assets/projects/project2.png" alt="Aware Wilderness"/>
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="bg-white bg-opacity-75 p-4 rounded-lg shadow-lg">
            ...
            <a href="https://care.talktomissmp.com/" target="_blank" rel="noopener noreferrer" className="relative group w-1/3">
              <img className="h-auto w-full shadow-lg dark:shadow-black/30 transition-transform duration-500 group-hover:scale-110 group-hover:blur-sm rounded-lg" src="src/assets/projects/project3.png" alt="CARE Platform"/>
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-500">
                <div className="bg-white bg-opacity-75 p-4 rounded-lg shadow-lg">
        ...
        <div className="lg:w-1/2 mt-8 lg:mt-0 flex justify-center">
          <img src="src/assets/Destination-Image-eb10ae12 7.23.22 PM.png" className="w-64 lg:w-96"/>
        </div>
      </div>
